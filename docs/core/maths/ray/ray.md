...
| [**RayReturn**](ray-return.md) | [**intersects**](../../../incomplete-docs.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**Body2D**](../../../incomplete-docs.md)& body, [**size_t**](https://en.cppreference.com/w/cpp/types/size_t) shape | Casts ray against a specific shape index on a 2D physics body. |
