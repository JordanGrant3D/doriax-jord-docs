...
| [**Side**](plane-side.md) | [**getSide**](plane-get-side.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**AABB**](../../object/physics/2D/aabb/aabb.md)& box | Tells which side of the plane an AABB lies on. |
| [**Side**](plane-side.md) | [**getSide**](plane-get-side.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**OBB**](../../object/physics/3D/obb/obb.md)& obb | Tells which side of the plane an OBB lies on. |
