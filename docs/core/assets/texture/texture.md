...
| [**Framebuffer\***](framebuffer.md) framebuffer | Wraps a render target for the minimap feed. |
...
| :--- | :--- | :--- | :--- |
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setMinFilter**](texture-min-filter.md) | [**TextureFilter**](texture-filter.md) filter | Minification filter used when the sprite is rendered smaller than its native resolution. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setFramebuffer**](texture-set-framebuffer.md) | [**Framebuffer\***](framebuffer.md) framebuffer | Points the texture at a render target so the minimap camera output can be sampled like any sprite. |
...
| [**TextureRender**](../texture-render/texture-render.md)* | [**getRender**](texture-get-render.md) | [**TextureRender\***](../texture-render/texture-render.md) fallBackTexture = [**NULL**](../../../core/ecs/entity-null-entity.md) | Returns the backend [TextureRender](. |
...
| [**Framebuffer\***](framebuffer.md) | [**getFramebuffer**](texture-get-framebuffer.md) |  | Returns the bound render target, or `nullptr` for regular sprites. |
