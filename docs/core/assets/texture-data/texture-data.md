...
| [**int**](https://en.cppreference.com/cpp/keyword/int) width, [**int**](https://en.cppreference.com/cpp/keyword/int) height, [**unsigned**](https://en.cppreference.com/cpp/keyword/unsigned) [**int**](https://en.cppreference.com/cpp/keyword/int) size, [**ColorFormat**](../../../assets/texture/color-format/color-format.md) color_format, [**int**](https://en.cppreference.com/cpp/keyword/int) channels, [**void\***](https://en.cppreference.com/cpp/keyword/void) data | Wraps an explicit pixel allocation. |
...
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**loadTexture**](texture-data-load-texture.md) | [**Data\***](../../../io/data/data.md) filedata | Decodes pixels from an already-opened `Data` file object (auto-detects SVG versus raster). |
...
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**loadCubeMapFromSingleFile**](texture-data-load-cubemap-from-single-file.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**char\***](https://en.cppreference.com/cpp/keyword/char) filename, [**std::array**](https://en.cppreference.com/w/cpp/container/array)<[**TextureData**](texture-data.md), 6>& data | Splits one cross-layout skybox image into six face buffers for the CharacterController reflection probe, avoiding six separate file opens on the loading screen. |
...
| [**ColorFormat**](../../../assets/texture/color-format/color-format.md) | [**getColorFormat**](texture-data-get-color-format.md) |  | Pixel layout (`RED`, `RGBA`, `RED16`). |
...
| [**int**](https://en.cppreference.com/cpp/keyword/int) | [**getBytesPerChannel**](texture-data-get-bytes-per-channel.md) | [**ColorFormat**](../../../assets/texture/color-format/color-format.md) format | Static helper returning bytes per channel for a format (`2` for `RED16`, `1` otherwise). |
