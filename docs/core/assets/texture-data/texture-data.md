...
| [**int**](https://en.cppreference.com/cpp/keyword/int) width, [**int**](https://en.cppreference.com/cpp/keyword/int) height, [**unsigned**](https://en.cppreference.com/cpp/keyword/unsigned) [**int**](https://en.cppreference.com/cpp/keyword/int) size, [**ColorFormat**](../texture/color-format/color-format.md) color_format, [**int**](https://en.cppreference.com/cpp/keyword/int) channels, [**void\***](https://en.cppreference.com/cpp/keyword/void) data | Wraps an explicit pixel allocation. |
...
| [**ColorFormat**](../texture/color-format/color-format.md) | [**getColorFormat**](texture-data-get-color-format.md) |  | Pixel layout (`RED`, `RGBA`, `RED16`). |
...
| [**int**](https://en.cppreference.com/cpp/keyword/int) | [**getBytesPerChannel**](texture-data-get-bytes-per-channel.md) | [**ColorFormat**](../texture/color-format/color-format.md) format | Static helper returning bytes per channel for a format (`2` for `RED16`, `1` otherwise). |
