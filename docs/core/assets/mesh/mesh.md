...
| :--- | :--- |
| [**Scene**](../../../incomplete-docs.md)* scene | Constructs a mesh and adds its mesh component. |
| [**Scene**](../../../incomplete-docs.md)* scene, [**Entity**](../../../core/ecs/entity.md) entity | Wraps an existing scene entity as a mesh without adding components. |
