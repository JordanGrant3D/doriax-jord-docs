...
| [**MaterialAlphaMode**](../../../assets/material/material-alpha-mode/material-alpha-mode.md) | [**alphaMode**](material-alpha-mode.md) | How combined alpha is rendered (`AUTO`, `ALPHA_OPAQUE`, `MASK`, `BLEND`). Defaults to `AUTO`. |
