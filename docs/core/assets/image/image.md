...
| :--- | :--- |
| Scene* scene | Constructs an image on a new scene entity with `UIComponent` and `ImageComponent` attached. |
| Scene* scene, Entity entity | Wraps an existing scene entity as an image without adding components. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setTexture**](image-set-texture.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**std::string**](https://en.cppreference.com/w/cpp/string/basic_string)& id, TextureData data | Displays in-memory pixel data cached under `id`. |
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setTexture**](image-set-texture.md) | Framebuffer* framebuffer | Displays a framebuffer for render-to-texture UI. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setColor**](image-color.md) | [**Vector4**](../../maths/vector4/vector4.md) color | Tints the image with an sRGB colour. |
