...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setTexture**](image-set-texture.md) | [**Framebuffer\***](../texture/framebuffer.md) framebuffer | Displays a framebuffer for render-to-texture UI. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setColor**](image-color.md) | [**Vector4**](../../maths/vector4/vector4.md) [**color**](../../../maths/color/color.md) | Tints the image with an sRGB colour. |
