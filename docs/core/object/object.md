...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setPosition**](../../incomplete-docs.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**float**](https://en.cppreference.com/cpp/keyword/float) x, [**const**](https://en.cppreference.com/cpp/keyword/const) y, [**const**](https://en.cppreference.com/cpp/keyword/const) z | Sets the local position of the object using separate coordinates. |
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setPosition**](../../incomplete-docs.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) x, [**const**](https://en.cppreference.com/cpp/keyword/const) y | Sets the local 2D position of the object, with Z set to zero. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setRotation**](../../incomplete-docs.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) xAngle, [**const**](https://en.cppreference.com/cpp/keyword/const) yAngle, [**const**](https://en.cppreference.com/cpp/keyword/const) zAngle | Sets the local rotation of the object using Euler angles. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setScale**](../../incomplete-docs.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) factor | Sets uniform local scale across all axes. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setBillboardRotation**](../../incomplete-docs.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) xAngle, [**const**](https://en.cppreference.com/cpp/keyword/const) yAngle, [**const**](https://en.cppreference.com/cpp/keyword/const) zAngle | Sets the billboard rotation using Euler angles. |
