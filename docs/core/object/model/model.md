...
| [**Bone**](bone.md) | [**getBone**](model-get-bone.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**std::string**](https://en.cppreference.com/w/cpp/string/basic_string)& name | Returns the joint handle by bone name for procedural transform overrides. |
| [**Bone**](bone.md) | [**getBone**](model-get-bone.md) | [**int**](https://en.cppreference.com/cpp/keyword/int) id | Returns the joint handle by glTF node index. |
