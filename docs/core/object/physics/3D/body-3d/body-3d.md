...
| [**Shape3DType**](../../../../../object/physics/3D/shape-3d-type/shape-3d-type.md) | [**getShapeType**](body-3d-get-shape-type.md) | [**size_t**](https://en.cppreference.com/w/cpp/types/size_t) index | Gets the type of the shape at the given index. |
