...
| [**OBB**](obb.md) obb | Copy constructor. |
...
| [**AABB**](../../2D/aabb/aabb.md) aabb | Constructs an OBB from an AABB. |
| [**AABB**](../../2D/aabb/aabb.md) aabb, [**Matrix4**](../../../../maths/matrix4/matrix4.md) transform | Constructs an OBB from an AABB and a transform matrix. |
...
| :--- | :--- | :--- | :--- |
| [**OBB**](obb.md)& | [**operator=**](../../../../../incomplete-docs.md) | [**OBB**](obb.md) rhs | Assignment operator. |
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**operator==**](../../../../../incomplete-docs.md) | [**OBB**](obb.md) rhs | Checks equality between two OBBs. |
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**operator!=**](../../../../../incomplete-docs.md) | [**OBB**](obb.md) rhs | Checks inequality between two OBBs. |
| [**std::string**](https://en.cppreference.com/w/cpp/string/basic_string) | [**toString**](../../../../../incomplete-docs.md) |  | Returns a string representation of the OBB. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**transform**](../../../../../incomplete-docs.md) | [**Matrix4**](../../../../maths/matrix4/matrix4.md) matrix | Transforms the OBB by a matrix. |
...
| [**AABB**](../../2D/aabb/aabb.md) | [**toAABB**](../../../../../incomplete-docs.md) |  | Converts the OBB to an AABB representation. |
| [**Matrix4**](../../../../maths/matrix4/matrix4.md) | [**toMatrix**](../../../../../incomplete-docs.md) |  | Converts the OBB to a matrix representation. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**enclose**](../../../../../incomplete-docs.md) | [**OBB**](obb.md) other | Encloses another OBB. |
...
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**intersects**](../../../../../incomplete-docs.md) | [**OBB**](obb.md) other | Checks for intersection with another OBB. |
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**intersects**](../../../../../incomplete-docs.md) | [**AABB**](../../2D/aabb/aabb.md) aabb | Checks for intersection with an AABB. |
...
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**contains**](../../../../../incomplete-docs.md) | [**OBB**](obb.md) other | Checks if the OBB contains another OBB. |
