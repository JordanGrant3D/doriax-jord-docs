...
| [**AABB**](aabb.md) rkBox | Copy constructor. |
...
| [**float**](https://en.cppreference.com/cpp/keyword/float) mx, [**float**](https://en.cppreference.com/cpp/keyword/float) my, [**float**](https://en.cppreference.com/cpp/keyword/float) mz, [**float**](https://en.cppreference.com/cpp/keyword/float) [**Mx**](../../../../../incomplete-docs.md), [**float**](https://en.cppreference.com/cpp/keyword/float) [**My**](../../../../../incomplete-docs.md), [**float**](https://en.cppreference.com/cpp/keyword/float) [**Mz**](../../../../../incomplete-docs.md) | Constructs an AABB with specified coordinate components. |
...
| :--- | :--- | :--- | :--- |
| [**AABB**](aabb.md) | [**operator=**](../../../../../incomplete-docs.md) | [**AABB**](aabb.md) rhs | Assignment operator. |
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**operator==**](../../../../../incomplete-docs.md) | [**AABB**](aabb.md) rhs | Checks equality between two AABBs. |
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**operator!=**](../../../../../incomplete-docs.md) | [**AABB**](aabb.md) rhs | Checks inequality between two AABBs. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setExtents**](../../../../../incomplete-docs.md) | [**float**](https://en.cppreference.com/cpp/keyword/float) mx, [**float**](https://en.cppreference.com/cpp/keyword/float) my, [**float**](https://en.cppreference.com/cpp/keyword/float) mz, [**float**](https://en.cppreference.com/cpp/keyword/float) [**Mx**](../../../../../incomplete-docs.md), [**float**](https://en.cppreference.com/cpp/keyword/float) [**My**](../../../../../incomplete-docs.md), [**float**](https://en.cppreference.com/cpp/keyword/float) [**Mz**](../../../../../incomplete-docs.md) | Sets the minimum and maximum extents using component values. |
...
| [**AABB**](aabb.md)& | [**merge**](../../../../../incomplete-docs.md) | [**AABB**](aabb.md) rhs | Merges this box with another AABB. |
| [**AABB**](aabb.md)& | [**merge**](../../../../../incomplete-docs.md) | [**Vector3**](../../../../maths/vector3/vector3.md) point | Merges this box with a point. |
| [**AABB**](aabb.md)& | [**transform**](../../../../../incomplete-docs.md) | [**Matrix4**](../../../../maths/matrix4/matrix4.md) matrix | Transforms this AABB by a matrix. |
...
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**intersects**](../../../../../incomplete-docs.md) | [**AABB**](aabb.md) b2 | Checks for intersection with another AABB. |
...
| [**AABB**](aabb.md) | [**intersection**](../../../../../incomplete-docs.md) | [**AABB**](aabb.md) b2 | Calculates the intersection box with another AABB. |
...
| [**bool**](https://en.cppreference.com/cpp/keyword/bool) | [**contains**](../../../../../incomplete-docs.md) | [**AABB**](aabb.md) other | Checks if the AABB contains another AABB. |
