...
| [**Framebuffer\***](../../assets/texture/framebuffer.md) | [**getFramebuffer**](camera-render-to-texture.md) |  | Returns the internal framebuffer. Valid only after `setRenderToTexture(true)`. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setFramebufferFilter**](camera-render-to-texture.md) | [**TextureFilter**](../../assets/texture/texture-filter.md) filter | Sets the sampling filter of the framebuffer output texture. |
