...
| [**std::vector&**](https://en.cppreference.com/w/cpp/container/vector)lt;[**Touch&**](../../input/touch/touch.md)gt; | [**getTouches**](input-get-touches.md) |  | All active touch contacts, each with a `pointer` id and a `position`. |
...
| [**std::vector&**](https://en.cppreference.com/w/cpp/container/vector)lt;[**Gamepad&**](../../input/gamepad/gamepad.md)gt; | [**getGamepads**](input-get-gamepads.md) |  | All connected controllers with their button and axis state. |
