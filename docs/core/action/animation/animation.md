...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**addActionFrame**](animation-add-action-frame.md) | [**float**](https://en.cppreference.com/cpp/keyword/float) startTime, [**Entity**](../../ecs/entity.md) timedAction, [**Entity**](../../ecs/entity.md) target | Adds a frame that follows the action's own duration, with an explicit target. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**addActionFrame**](animation-add-action-frame.md) | [**float**](https://en.cppreference.com/cpp/keyword/float) startTime, [**Entity**](../../ecs/entity.md) timedAction | Adds a frame that follows the action's own duration, targeting the animation's own target. |
