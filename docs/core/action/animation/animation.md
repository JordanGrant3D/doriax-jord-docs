...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**addActionFrame**](animation-add-action-frame.md) | [**float**](https://en.cppreference.com/cpp/keyword/float) startTime, [**Entity**](../../ecs/entity.md) [**timedAction**](../../../action/timed-action/timed-action.md), [**Entity**](../../ecs/entity.md) target | Adds a frame that follows the action's own duration, with an explicit target. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**addActionFrame**](animation-add-action-frame.md) | [**float**](https://en.cppreference.com/cpp/keyword/float) startTime, [**Entity**](../../ecs/entity.md) [**timedAction**](../../../action/timed-action/timed-action.md) | Adds a frame that follows the action's own duration, targeting the animation's own target. |
...
| [**ActionFrame**](../../../action/action-frame/action-frame.md)& | [**getActionFrame**](animation-get-action-frame.md) | [**unsigned**](https://en.cppreference.com/cpp/keyword/unsigned) [**int**](https://en.cppreference.com/cpp/keyword/int) index | Returns a reference to the frame at the given zero-based index. |
