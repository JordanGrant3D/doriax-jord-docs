...
| [**TextureFilter**](../../incomplete-docs.md) | [**fixedResolutionFilter**](scene-fixed-resolution-filter.md) | Sampling filter used when upscaling the fixed-resolution image. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setFixedResolutionFilter**](scene-fixed-resolution-filter.md) | [**TextureFilter**](../../incomplete-docs.md) filter | Sets the fixed-resolution upscale filter. |
| [**TextureFilter**](../../incomplete-docs.md) | [**getFixedResolutionFilter**](scene-fixed-resolution-filter.md) |  | Returns the fixed-resolution upscale filter. |
