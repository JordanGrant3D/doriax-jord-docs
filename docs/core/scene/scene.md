...
| **ShadowQuality** | [**shadowQuality**](scene-shadow-quality.md) | PCF filter quality of 3D shadow map edges. |
...
| **TextureFilter** | [**fixedResolutionFilter**](scene-fixed-resolution-filter.md) | Sampling filter used when upscaling the fixed-resolution image. |
| **LightState** | [**lightState**](scene-light-state.md) | Whether the render system activates the lighting pass. |
...
| **ShadowQuality** | [**shadow2DQuality**](scene-shadow-2d-quality.md) | Filter quality of 2D light shadows. |
...
| **UIEventState** | [**enableUIEvents**](scene-enable-ui-events.md) | Per-scene override for UI event routing. |
...
| EntityPool defaultPool | Creates an empty scene with a custom entity pool and registers the default subsystems. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setShadowQuality**](scene-shadow-quality.md) | **ShadowQuality** quality | Sets the PCF filter quality of 3D shadow map edges. |
| **ShadowQuality** | [**getShadowQuality**](scene-shadow-quality.md) | | Returns the 3D shadow map filter quality. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setFixedResolutionFilter**](scene-fixed-resolution-filter.md) | **TextureFilter** filter | Sets the fixed-resolution upscale filter. |
| **TextureFilter** | [**getFixedResolutionFilter**](scene-fixed-resolution-filter.md) | | Returns the fixed-resolution upscale filter. |
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setLightState**](scene-light-state.md) | **LightState** state | Controls whether the lighting pass is activated. |
| **LightState** | [**getLightState**](scene-light-state.md) | | Returns the lighting activation state. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setShadow2DQuality**](scene-shadow-2d-quality.md) | **ShadowQuality** quality | Sets the filter quality of 2D light shadows. |
| **ShadowQuality** | [**getShadow2DQuality**](scene-shadow-2d-quality.md) | | Returns the 2D shadow filter quality. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setDefaultCustomShader**](scene-default-custom-shader.md) | **ShaderType** type, [**const**](https://en.cppreference.com/cpp/keyword/const) [**std::string**](https://en.cppreference.com/w/cpp/string/basic_string)& path | Sets the scene-wide custom shader for a category. |
| [**const**](https://en.cppreference.com/cpp/keyword/const) [**std::string**](https://en.cppreference.com/w/cpp/string/basic_string)& | [**getDefaultCustomShader**](scene-default-custom-shader.md) | **ShaderType** type | Returns the scene-wide custom shader path for a category. |
...
| **UIEventState** | [**getEnableUIEvents**](scene-enable-ui-events.md) | | Returns the per-scene UI event override. |
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**setEnableUIEvents**](scene-enable-ui-events.md) | **UIEventState** enableUIEvents | Overrides per-scene UI event routing. |
...
| **std::shared_ptr<T>** | [**registerSystem**](scene-register-system.md) | | Registers a subsystem of type `T` on this scene. |
| **std::shared_ptr<T>** | [**getSystem**](scene-get-system.md) | | Returns the registered subsystem of type `T`. |
