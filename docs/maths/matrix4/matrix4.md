...
| :--- | :--- | :--- |
| float[4][4] | [**matrix**](matrix4-matrix.md) | Raw column-major entries (`matrix[col][row]`). |
...
| **AABB** | [**operator \***](matrix4-operator-transform-aabb.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) **AABB**& aabb | Transforms an AABB into world space. |
| **OBB** | [**operator \***](matrix4-operator-transform-obb.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) **OBB**& obb | Transforms an OBB into world space. |
...
| [**Vector4**](../vector4/vector4.md) | [**column**](matrix4-column.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**unsigned**](https://en.cppreference.com/cpp/keyword/unsigned) [**int**](https://en.cppreference.com/cpp/keyword/unsigned) column | Returns a column as a `Vector4`. |
...
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**decomposeStandard**](matrix4-decompose-standard.md) | [**Vector3**](../vector3/vector3.md)& position, [**Vector3**](../vector3/vector3.md)& scale, **Quaternion**& rotation | Splits into position, scale and rotation (Gram-Schmidt). |
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**decomposeQDU**](matrix4-decompose-qdu.md) | [**Vector3**](../vector3/vector3.md)& position, [**Vector3**](../vector3/vector3.md)& scale, **Quaternion**& rotation | Splits into position, scale and rotation via QDU. |
| [**void**](https://en.cppreference.com/cpp/keyword/void) | [**decompose**](matrix4-decompose.md) | [**Vector3**](../vector3/vector3.md)& position, [**Vector3**](../vector3/vector3.md)& scale, **Quaternion**& rotation | Splits into position, scale and rotation (calls `decomposeQDU`). |
