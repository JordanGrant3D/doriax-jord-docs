...
| :--- | :--- |
| [**ZERO**](vector3-zero.md) | Shorthand for writing `Vector3(0, 0, 0)`. |
| [**UNIT_X**](vector3-unit-x.md) | Shorthand for writing `Vector3(1, 0, 0)`. |
| [**UNIT_Y**](vector3-unit-y.md) | Shorthand for writing `Vector3(0, 1, 0)`. |
| [**UNIT_Z**](vector3-unit-z.md) | Shorthand for writing `Vector3(0, 0, 1)`. |
| [**UNIT_SCALE**](vector3-unit-scale.md) | Shorthand for writing `Vector3(1, 1, 1)`. |

## Properties

| Property | Description |
| :--- | :--- |
| [**this[uint]**](vector3-index.md) | Access the x, y, z components using `[0]`, `[1]`, `[2]` respectively. |
| [**x**](vector3-x.md) | X component of the vector. |
| [**y**](vector3-y.md) | Y component of the vector. |
| [**z**](vector3-z.md) | Z component of the vector. |

## Methods

| Method | Description |
| :--- | :--- |
| [**isValid**](../../incomplete-docs.md) | Checks that `x`, `y`, and `z` components are finite numbers. |
