...
| :--- | :--- | :--- | :--- |
| [**float**](https://en.cppreference.com/cpp/keyword/float) | [**operator []**](rect-operator-index.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**size_t**](https://en.cppreference.com/cpp/types/size_t) i | Returns component value by index (0: x, 1: y, 2: width, 3: height). |
| [**float&**](https://en.cppreference.com/cpp/keyword/float) | [**operator []**](rect-operator-index.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) [**size_t**](https://en.cppreference.com/cpp/types/size_t) i | Returns a reference to component by index (0: x, 1: y, 2: width, 3: height). |
...
| [**std::string**](https://en.cppreference.com/cpp/string/basic_string) | [**toString**](rect-to-string.md) | | Returns a string representation of the rectangle. |
