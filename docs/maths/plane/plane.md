...
| [**Side**](plane-side.md) | [**getSide**](plane-get-side.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) **AABB**& box | Tells which side of the plane an AABB lies on. |
| [**Side**](plane-side.md) | [**getSide**](plane-get-side.md) | [**const**](https://en.cppreference.com/cpp/keyword/const) **OBB**& obb | Tells which side of the plane an OBB lies on. |
